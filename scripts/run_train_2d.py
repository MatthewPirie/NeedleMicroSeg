...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--model_variant", type=str, default="small", choices=["small", "base"])
...
def main() -> None:
    ...
    for epoch in range(start_epoch, epochs + 1):
        ...
        writer.add_scalar("val/dice_score", val_metrics["val_dice_score"], epoch)
        writer.flush()
        ...
        print(
            ...
            f"val_dice={val_metrics['val_dice_score']:.4f}",
            flush=True,
        )

        # Save metrics (JSONL for easy parsing later)
        ...
        if args.save_best and val_metrics["val_dice_score"] > best_val_dice:
            best_val_dice = val_metrics["val_dice_score"]
